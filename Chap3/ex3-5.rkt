...
; Consider computing the area of a region of space described by a predicate P(x , y) 
; that is true for points (x , y) in the region and false for points not in the region. 
; For example, the region contained within a circle of radius 3 centered at (5, 7) is described by the predicate that tests
...
; in the region should give an estimate of the proportion of the rectangle that lies in the region.
...
; Use your estimateintegral to produce an estimate of pi by measuring the area of a unit circle.
