#lang sicp
(#%provide has-value? get-value set-value! forget-value! connect inform-about-value inform-about-no-value
           for-each-except
           make-connector constant adder multiplier probe)
          ...
          (if (eq? retractor informant)
              (begin (set! informant false)
                     (for-each-except retractor
                                      ...
                                      constraints))
              (display "<forget-my-value> ignored")))
...
(define (multiplier m1 m2 product)
    (define (process-new-value)
        (cond ((or (and (has-value? m1) (= (get-value m1) 0)) (and (has-value? m2) (= (get-value m2) 0))) (set-value! product 0 me))
