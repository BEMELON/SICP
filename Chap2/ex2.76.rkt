...
; be needed. For each of the three strategies—generic operations with explicit dispatch, data-directed style, and messagepassing-style—describe the changes that must be made to a
